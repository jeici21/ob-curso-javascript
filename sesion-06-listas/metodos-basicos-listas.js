...
//array[índice] => 0, 1, 2, 3, 4, 5,...
console.log(array[0]);
console.log(array[1]);
console.log(array[2]);
console.log(array[3]);

//Métodos para introducir nuevos valores en nuestros artrays
...
//Eliminar valores .splice(índice, numValoresAEliminar)
array3.splice(2, 1);
console.log(array3);

//Añadir valores .splice(índice, 0, valores)
array3.splice(2, 0, "hola");
console.log(array3);

//Modificar valores .splice(índice, 1, valores)
array3.splice(2, 1, 3);
console.log(array3);