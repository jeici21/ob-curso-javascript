...
const res = array.some(valor => valor < 10);//si hay al menos 1 coincidencia devuelve true
console.log(res);
...
const ar_str = Array.from(str);//convierte string en array
console.log(ar_str);

const set = new Set([2, 3, "hola", 4]);//set de elementos
const ar_set = Array.from(set);
console.log(ar_set);

const keys = array.keys();//conjunto de llaves, enumeradas
console.log(keys);
