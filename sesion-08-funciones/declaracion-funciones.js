...
saludar();//no enviar parámetros devuelve undefined
...
//////
function imprimir(...parametros) {//tantos parámetros como queramos
...
//////
function suma(...nums) {
    return nums.reduce((a, b) => a + b);//return para devolver valor a una variable o constante
}
